...
An interactive/CLI wordlist generating tool for brute-forcing "strong" human generated passwords with user inputted phrases, dates, and web-scraped related keywords. 
